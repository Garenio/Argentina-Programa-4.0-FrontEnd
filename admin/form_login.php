...
<head>
    ...
    <title>TecnoNews | Inicio de sesión</title>
</head>
...
<body>
    ...
    <div class=" text-center">
        <div class="row">
            <div class="form-signin card col-6 offset-3 p-3 mt-5 shadow-lg rounded-4">
                <div class="mb-5">
                    <?php
                    if (isset($mensaje)) {
                ...
                <form action="../backend/login.php" method="post" class="">
                    ...
                    <h1 class="h3 mb-3 fw-normal text-white">Ingrese sus datos</h1>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="submit" class="btn btn-outline-light mt-2" id="enviar" name="enviar"
                            value="Ingresar">

...
<head>
    ...
    <title>TecnoNews | Editar un artículo</title>
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="categoria" name="categoria" required>
                    <option value="Tecnologia" <?php if ($resultado['categoria'] == "Tecnologia")
                        print("selected"); ?>>Tecnología
                    </option>
                    <option value="Gaming" <?php if ($resultado['categoria'] == "Gaming")
                        print("selected"); ?>>Gaming</option>
                    <option value="Reviews" <?php if ($resultado['categoria'] == "Reviews")
